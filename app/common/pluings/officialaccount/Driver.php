...
class Driver extends Manager
{
    ...
    protected $namespace = '\\app\\common\\pluings\\officialaccount\\driver\\';
    ...
    {
        if (!is_null($name)) {
            return $this->app->config->get('officialaccount.' . $name, $default);
        }

        return $this->app->config->get('officialaccount');
    }
