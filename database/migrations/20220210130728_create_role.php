...
class CreateRole extends Migrator
{
    ...
    {
        $table = $this->table("role",['comment'=>'角色','engine'=>'Innodb','collation'=>'utf8mb4_general_ci']);
        // 表必备字段
        ...
        $table->addSoftDelete();
        // 业务字段
        $table->addColumn(Column::string('name')->setLimit(20)->setComment('角色名称'));
        $table->addColumn(Column::json('rules')->setComment('权限key'));
